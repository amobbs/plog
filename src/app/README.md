...
As `Preslog` is quite minimal, take a look at the two provided submodules
...
```js
.config( function PreslogConfig ( $routeProvider ) {
...
One of the design philosophies of `Preslog` is that tests should exist
