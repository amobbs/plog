...
module.exports = {
    ...
    vendor_files: {
        ...
        js: [
            ...
            'vendor/highcharts.com/js/highcharts.src.js',
            'vendor/highcharts.com/js/modules/exporting.src.js',
            'vendor/angular-unstable/angular.js',
            'vendor/angular-bootstrap/ui-bootstrap-tpls.min.js',
            'vendor/angular-ui-router/src/common.js',
            'vendor/angular-ui-router/src/resolve.js',
            'vendor/angular-ui-router/src/templateFactory.js',
            'vendor/angular-ui-router/src/urlMatcherFactory.js',
            'vendor/angular-ui-router/src/urlRouter.js',
            'vendor/angular-ui-router/src/state.js',
            'vendor/angular-ui-router/src/viewDirective.js',
            'vendor/angular-ui-router/src/view.js',
            'vendor/angular-ui-router/src/stateDirectives.js',
            'vendor/angular-ui-router/src/compat.js',
