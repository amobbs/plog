...
class PrimeLogShell extends AppShell {
	...
	public function main() {
		...
		$sheet->getStyle('A1:L3')->applyFromArray(array(
			'fill' => array(
				'type' => PHPExcel_Style_Fill::FILL_SOLID,
				'color' => array('rgb' => '0070C0')
			)
		));
		$sheet->getStyle('M1:U3')->applyFromArray(array(
			'fill' => array(
				'type' => PHPExcel_Style_Fill::FILL_SOLID,
		...
		$sheet->mergeCells('M1:U2');
		$sheet->setCellValue('M1','ASSIGNMENTS AND NOTIFICATIONS');
		...
		$sheet->setCellValue('P3', 'News');
		$sheet->setCellValue('Q3', 'Br Eng');
		$sheet->setCellValue('R3', 'Tx Eng');
		$sheet->setCellValue('S3', 'On Air');
		$sheet->setCellValue('T3', 'Prod');
		$sheet->setCellValue('U3', 'Department Comments');
